...
/* -- defines some values for the control field in header --
 * integers are the decimal represantation of the binary
 * of the 16-bit type of control variable
 */
                       /* MSbit(15).......LSbit(0) */
#define SYN 16384      /* 16384 = 0100000000000000 */
#define ACK 4096       /* 4096  = 0001000000000000 */
#define SYN_ACK 20480  /* 20480 = 0101000000000000 */
#define FIN 32768      /* 32768 = 1000000000000000 */
#define FIN_ACK 36864  /* 36864 = 1001000000000000 */
#define RST 8192       /* 8192  = 0010000000000000 */
...
/* distinguish whether socket refers to SERVER or CLIENT */
typedef enum
{
  SERVER,
  CLIENT
...
typedef struct
{
  ...
  mircotcp_id_t id;             /* Distinguish between server and client */
  ...
  struct sockaddr_in address;   /* Save address for when terminating */
